            ...
            <div class="tab-pane show active" id="all-chats" tabindex="0" role="tabpanel">
                <ul class="tyn-aside-list">
                    @forelse ($users as $user)
                        <li class="tyn-aside-item js-toggle-main {{ $selectedUserId === $user->id ? 'active' : '' }}"  wire:click="selectUser({{ $user->id }})" style="cursor: pointer;" >
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <ul class="tyn-list-links">
                    ...
                    <li><a href="#">
                            ...
                            <span>Mute Notifications</span></a></li>
